...
study = StudyDefinition(
    ...
    ast_writpastp_first_sameday=patients.with_these_clinical_events(
        codelist=writpastp_cod,
        between=["ast_rev_first", "ast_rev_first"],
        returning="binary_flag",
        return_expectations={
            "incidence": 0.10
        },
    ...
    ast_writpastp_first_oneday=patients.with_these_clinical_events(
        codelist=writpastp_cod,
...
measures = [
    ...
    Measure(
        id="ast_writpastp_first_sameday_rate",
        numerator="ast_writpastp_first_sameday",
        denominator="population",
        group_by="population",
        small_number_suppression=True
    ),
    ...
    Measure(
        id="ast_writpastp_first_sameday_rate",
        numerator="ast_writpastp_first_oneday",
        denominator="population",
        group_by="population",
        small_number_suppression=True
    ),
